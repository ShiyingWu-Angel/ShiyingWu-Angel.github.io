...
```{r, include = FALSE}
load("resource/data/mergedPA.RData")
...
<p>
  <a href="https://yt4617.shinyapps.io/shiny_dashboard_template/" target="_blank">
    Open Full Screen App
  </a>
</p>
<iframe 
  src="https://yt4617.shinyapps.io/shiny_dashboard_template/" 
  width="100%" 
  height="750px"
...
## Want to know more about this project & Restaurant in PA?
![](resource/image/yelp-top-100-us-restaurants.jpeg)
...
county <- read_csv("resource/data/PA-city-county.csv", show_col_types = FALSE)
...
Read [Regional Analyzation](yelp/yelp_Regional.html) here.

## Rating-Associated Factors
We made an in-depth [Exploratory Analysis](yelp/yelp_Stars.html) about restaurant rating, and at last we identified the indicators of rating and constructed the model for predicting the restaurants ratings.

## Popularity Modeling

We extended our analysis beyond ratings by constructing a **popularity score** that combines star ratings and review counts, placing more weight on review volume to better reflect real customer engagement.mWe then developed regression models to identify key factors associated with restaurant popularity. After addressing skewness through log transformation and refining model specifications, we identified several significant predictors.

For full model building process, diagnostics, and regression outputs, see:[Model Building](yelp/yelp_Model-building.html)

## Report
Browse our [report](yelp/yelp_Report.html) for key insights from our analysis!

---


For more informartion about yelp.data and some nice restaurant, check out https://www.yelp.com/dataset
![](resource/image/looking.png)